...
const Companies = () => {
  return (
    <div className="py-24 px-20 w-full flex flex-col items-center justify-center">
      ...
      {/* <div className="grid grid-cols-5 my-12 gap-16">
        <img
          src="https://appinventiv.com/wp-content/themes/twentynineteen-child/new-images/ikea-logo-color.svg"
          alt="adobe"
          className="w-2/3 grayscale hover:filter-none cursor-pointer"
        />
        <img
