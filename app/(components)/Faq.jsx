...
const Faq = () => {
  return (
    <section
      className="w-full flex flex-col items-center justify-center bg-black text-white pb-4 lg:pb-10 px-8 xl:px-[145px]"
      id="faqs"
    >
      <h3 className="text-4xl mb-10">FAQs</h3>
      <div className="w-full max-w-[1100px] flex flex-col items-center justify-center">
        <div className="w-full my-2 lg:my-4 p-4">
          <h4 className="text-base lg:text-xl mb-1">How does it work?</h4>
          <p className="text-xs lg:text-base text-[#b6b6b6]">
        ...
        <div className="w-full my-2 lg:my-4 p-4">
          <h4 className="text-base lg:text-xl mb-1">
        ...
        <div className="w-full my-2 lg:my-4 p-4">
          <h4 className="text-base lg:text-xl mb-1">How do we communicate?</h4>
          <p className="text-xs lg:text-base text-[#b6b6b6]">
        ...
        <div className="w-full my-2 lg:my-4 p-4">
          <h4 className="text-base lg:text-xl mb-1">How secure is my data?</h4>
          <p className="text-xs lg:text-base text-[#b6b6b6]">
